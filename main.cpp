...
class Rectangle: public Integral{
    public:
        ...
        double* integral_value(double (*func)(double)){
            ...
            cout<<"Интеграл, вычисленный методом прямоугольников. \n";
            return f;
        }
...
class Trapeze: public Integral{
    public:
        ...
        double * integral_value(double (*func)(double)){
            ...
            cout<<"Интеграл, вычисленный методом трапеций.\n";
            return f;
        }
...
int main()
{
    ...
    double *f_val;
    double int_val; // итоговое значение интеграла
    // указатель *p ссылается на объекты разных типов, при этом вызываются разные виртуальные функции
    Integral *p;
    Rectangle obj1(4,9,50);
    Trapeze obj2(4,9,50);

    p=&obj1;
    f_val=p->integral_value(*fnc);
    int_val=obj1.Square(f_val);
    cout<<int_val<<endl;

    p=&obj2;
    f_val=p->integral_value(*fnc);
    int_val=obj2.Square(f_val);
    cout<<int_val<<endl;
